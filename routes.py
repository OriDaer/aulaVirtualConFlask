...
from models import Usuario, Curso, Contenido, Inscripcion
import os
...
app.secret_key = "supersecretkey"  # ⚠️ necesario para usar sesiones
...
def crear_curso():
    ...
    if request.method == 'POST':
        ...
        return redirect(url_for('home_profesor'))
    profesores = ["Profesor Juan Pérez", "Profesora Carolina"]
...
def ver_curso(id_curso):
    ...
    es_profesor = session.get('rol') == 'profesor'
    ...
    return render_template('ver_curso.html', curso=curso, contenidos=contenidos, es_profesor=es_profesor)
